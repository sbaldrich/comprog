...
\subsection{Comparison of floating point numbers }\label{util:cmp}
	\cppcodefile{../code/cpp/geometry/util/comp.cpp}
%:util:point
...
\subsection{Point Class}\label{util:point}
	...
	\cppcodefile{../code/cpp/geometry/util/point_minimal.cpp}
%:util:quadrant
\subsection{Quadrant}
...
\cppcodefile{../code/cpp/geometry/util/quadrant.cpp}  
...
\cppcodefile{../code/cpp/geometry/util/radcomp.cpp}
...
Requires \ref{util:cmp}:\verb|cmp| and \ref{util:point}:\verb|Point|.
\cppcodefile{../code/cpp/geometry/util/polarcomp.cpp} 
